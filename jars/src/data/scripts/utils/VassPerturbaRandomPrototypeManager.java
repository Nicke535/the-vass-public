...
public class VassPerturbaRandomPrototypeManager {
    ...
    static {
        PROTOTYPE_WEAPON_IDS.add("vass_prototype_s1");
        PROTOTYPE_WEAPON_IDS.add("vass_prototype_s2");
        PROTOTYPE_WEAPON_IDS.add("vass_prototype_m1");
        PROTOTYPE_WEAPON_IDS.add("vass_prototype_m2");
    }

    //Stats for prototype weapon randomization
    private static final float RANDOM_LASER_ARCHETYPE_WEIGHT = 5f;
    private static final float RANDOM_CANNON_ARCHETYPE_WEIGHT = 5f;
    private static final float DYRNWYN_ARCHETYPE_WEIGHT = 3f;
    private static final float CHRONOFLAK_ARCHETYPE_WEIGHT = 2f;
    ...
    public static PrototypeWeaponData generateRandomPrototypeStats(boolean energy, boolean medium) {
        ...
        if (archetype.equals("RANDOM_LASER")) {
            ...
            data = new PrototypeWeaponData(
                    medium ? MathUtils.getRandomNumberInRange(0.5f, 0.9f) : MathUtils.getRandomNumberInRange(2f, 4f), //Damage
                    1f, //Firerate
            ...
            data = new PrototypeWeaponData(
                    ...
                    Math.random() < 0.25f ? MathUtils.getRandomNumberInRange(3, 5) : 1f); //Shotgun Factor
        }
