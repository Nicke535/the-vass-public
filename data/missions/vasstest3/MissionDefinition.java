package data.missions.vasstest3;
...
public class MissionDefinition implements MissionDefinitionPlugin {
    ...
    public void defineMission(MissionDefinitionAPI api) {
        ...
        addShipPlayer("doom_Strike", 3);
        addShipPlayer("shade_Assault", 7);
        addShipPlayer("afflictor_Strike", 7);
        addShipPlayer("hyperion_Attack", 3);
        addShipPlayer("hyperion_Strike", 3);
        addShipPlayer("onslaught_Standard", 3);
        addShipPlayer("onslaught_Outdated", 3);
        addShipPlayer("onslaught_Elite", 1);
        addShipPlayer("astral_Elite", 3);
        addShipPlayer("astral_Strike", 3);
        addShipPlayer("astral_Attack", 3);
        addShipPlayer("paragon_Elite", 1);
        addShipPlayer("legion_Strike", 1);
        addShipPlayer("legion_Assault", 1);
        addShipPlayer("legion_Escort", 1);
        addShipPlayer("legion_FS", 1);
        addShipPlayer("odyssey_Balanced", 2);
        addShipPlayer("conquest_Elite", 3);
        addShipPlayer("eagle_Assault", 5);
        addShipPlayer("falcon_Attack", 5);
        addShipPlayer("venture_Balanced", 5);
        addShipPlayer("apogee_Balanced", 5);
        addShipPlayer("aurora_Balanced", 5);
        addShipPlayer("aurora_Balanced", 5);
        addShipPlayer("mora_Assault", 3);
        addShipPlayer("mora_Strike", 3);
        addShipPlayer("mora_Support", 3);
        addShipPlayer("dominator_Assault", 5);
        addShipPlayer("dominator_Support", 5);
        addShipPlayer("medusa_Attack", 5);
        addShipPlayer("condor_Support", 15);
        addShipPlayer("condor_Strike", 15);
        addShipPlayer("condor_Attack", 15);
        addShipPlayer("enforcer_Assault", 15);
        addShipPlayer("enforcer_CS", 15);
        addShipPlayer("hammerhead_Balanced", 10);
        addShipPlayer("hammerhead_Elite", 5);
        addShipPlayer("drover_Strike", 10);
        addShipPlayer("sunder_CS", 10);
        addShipPlayer("gemini_Standard", 8);
        addShipPlayer("buffalo2_FS", 20);
        addShipPlayer("lasher_CS", 20);
        addShipPlayer("lasher_Standard", 20);
        addShipPlayer("hound_Standard", 15);
        addShipPlayer("tempest_Attack", 15);
        addShipPlayer("brawler_Assault", 15);
        addShipPlayer("wolf_CS", 2);
        addShipPlayer("hyperion_Strike", 1);
        addShipPlayer("vigilance_Standard", 10);
        addShipPlayer("vigilance_FS", 15);
        addShipPlayer("tempest_Attack", 2);
        addShipPlayer("brawler_Assault", 10);
